...
from source.embeddings.cpe import CellsPositionalEmbedding
from source.embeddings.tpe import TablePositionalEmbedding
from source.embeddings.E1 import RowColumnEmbeddings
from source.embeddings.segment_embedding import SegmentEmbedding
