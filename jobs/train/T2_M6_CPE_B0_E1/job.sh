#!/bin/bash
#SBATCH --nodes=1
#SBATCH --job-name=v117
#SBATCH --gpus-per-node=1
#SBATCH --time=88:00:00
#SBATCH --partition=hard
#SBATCH --output=/home/raphael.gervillie/TabStructGit/jobs/train/T2_M6_CPE_B0_E1/results/ALL.out

python /home/raphael.gervillie/TabStructGit/run.py \
  --encoding_type T2_M6_CPE_B0_E1 \
  ...
  --output_dir /home/raphael.gervillie/TabStructGit/models/T2_M6_CPE_B0_E1/ALL \
  ...
  --logging_dir "/home/raphael.gervillie/TabStructGit/logs/train/T2_M6_CPE_B0_E1/ALL" \
  --logging_steps 50 \
